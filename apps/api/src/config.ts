...
export const config = {
  ...
  databaseUrl:
    process.env.DATABASE_URL ?? "postgres://vani:vani@127.0.0.1:5432/vani",
  dataDir: resolve(process.env.VANI_DATA_DIR ?? "./data"),
  demoMode: process.env.VANI_DEMO_MODE === "true",
  ...
  ollamaModel: process.env.OLLAMA_MODEL ?? "qwen3.8:27b-q4_K_M",
};
